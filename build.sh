...
# Set our directory
OUT_DIR=out/
VERSION="Pikachu-${DEVICE^^}-AOSP-${DATE}"
...
# Set compiler Path
export PATH="/home/bibin/device/kernalbuild/proton-clang/bin:$PATH"
...
git clone -q https://github.com/bibindasb/Anykernel3.git -b rmx3371 AnyKernel3
# Copy necessary files to AnyKernel3 directory
